...
<p align="center">
  <img alt="release" src="https://img.shields.io/badge/release-v0.2.1-brightgreen.svg">
...
Grab `jexray-<version>.jar` (e.g. `jexray-0.2.1.jar`) from the [latest release](https://github.com/cys7885/jexray/releases/latest). With the [GitHub CLI](https://cli.github.com/) it resolves the version for you:
